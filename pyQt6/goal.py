...
from PyQt6.QtWidgets import (
    ...
    QVBoxLayout, QGridLayout, QMessageBox, QHBoxLayout
)
...
class MazeSolver(QWidget):
    ...
    def solve(self, algorithm):
        if not self.start_prop or not self.goal_pos:
            QMessageBox.warning(self, "Warning", "Please set both Start and Goal.")
            return

        self.clear_path_visuals()
        path = algorithm(self.start_prop, self.goal_pos)
